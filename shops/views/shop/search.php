...
<div class="shop_block">
    ...
    <a href="<?php echo Yii::app()->createUrl('shop/show',array('id'=>$shop['id']));?>" title="<?php echo $shop['title'];?>"><?php echo CHtml::image(Constant::getShopImagePath().$shop['image'], $shop['title'],array('width'=>174, 'height'=>140) );?></a>
