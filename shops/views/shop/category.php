...
<div class="shop_block_list">
    ...
    <?php  foreach($shops as $shop): ?>
        <div class="shop_block">
            ...
            <a href="<?php echo Yii::app()->createUrl('shop/show',array('id'=>$shop['shop']['id']));?>" title="<?php echo $shop['shop']['title'];?>"><?php echo CHtml::image(Constant::getShopImagePath().$shop['shop']['join_time'].'_174x140.jpg', $shop['shop']['title'],array('width'=>174, 'height'=>140) );?></a>
