 ...
 *
 * eg:
 * $thumb = new Thumbnail(1, 50, 80, 70);
 * $thumb->createThumbnail('1.jpg', '1_s.jpg', true);
 */
class Thumbnail
{
    /**
     ...
     */
    public function createThumbnail($sourceImagePath, $destImagePath, $output = false, $destType = null, $quality = 80)
    {
        try
        {
            if(!file_exists($sourceImagePath))
                throw new Exception('Image file does not exist. (' . __FILE__ . ':' . __LINE__ . ')');
